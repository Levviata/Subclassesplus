...
{
	public class IronPellet : ModItem
	{
		...
		*/
		public override void SetDefaults()
		{
			...
			Item.maxStack = 9999;
			Item.knockBack = 1.3f; // Average knockback
		...
		{
			Recipe.Create(ModContent.ItemType<Content.ShotgunExpansion.Items.Ammo.PreBoss.IronPellet>(), 90)
